...
const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-full font-[500] text-sm transition-[transform,box-shadow,background-color,border-color,opacity] duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 select-none hover:shadow-[0_0_15px_rgba(0,84,253,0.4)] active:scale-[0.98]',
  {
    variants: {
      variant: {
