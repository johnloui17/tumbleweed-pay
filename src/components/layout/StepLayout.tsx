...
export function StepLayout({ children, currentStep }: StepLayoutProps) {
  ...
  return (
    <div className="h-screen w-full bg-white flex justify-center overflow-hidden">
      <main className="w-full h-full bg-[#F6F7F9] relative flex flex-col lg:grid lg:grid-cols-[47.5%_52.5%] overflow-hidden">
        ...
        {/* Illustration Panel */}
        <section className="relative flex flex-col items-start pt-8 pb-8 lg:pb-20 lg:pl-20 lg:pt-24 z-10 h-full overflow-hidden">
        ...
        {/* Form Panel */}
        <section className="relative flex items-center justify-center p-4 lg:p-0 lg:pr-8 lg:pt-20 lg:pb-8 lg:items-start lg:justify-start z-20 h-full overflow-hidden">
